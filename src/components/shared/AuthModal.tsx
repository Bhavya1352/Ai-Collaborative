            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="relative my-6">
                ...
                <div className="relative flex justify-center text-[9px] uppercase font-mono tracking-wider">
                  <span className="bg-[#fbfaf7] px-3 text-[#5e5f62]">Or continue with</span>
                </div>
              </div>
              ...
              <button
                ...
                disabled={loading}
                className="w-full h-10 border-2 border-[#1c1d22] bg-[#faf8f5] hover:bg-[#e9dcf8] text-[#1c1d22] rounded-none font-mono text-xs uppercase tracking-wider flex items-center justify-center gap-2 transition-colors font-bold"
              >
